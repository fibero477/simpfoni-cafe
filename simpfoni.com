...
<body>
    ...
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="#contact" onclick="scrollToSection(event, 'contact')">Kontak</a></li>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            <h1>Nikmati Harimu Dengan Secangkir Kopi</h1>
        ...
        <div class="menu-grid">
            ...
            <div class="menu-card">
                ...
                <div class="menu-content">
                    ...
                    <div class="menu-item">
                        <span>Kue Coklat</span>
                        <span class="menu-item-price">Rp 5.000</span>
                    </div>
                    <div class="menu-item">
                        <span>Roti Gulung</span>
                        <span class="menu-item-price">Rp 5.000</span>
                    </div>
                </div>
            </div>
    ...
    <section id="contact" class="contact">
        <div class="section-title">
            <h2>Tentang Kami</h2>
            <p>Kami ingin melihat anda di Simpfoni Cafe</p>
        </div>
